var Global = function() {
	...
	return {
		...
		showModel: function(message, opt) {
			...
			var modaltemplate = '<div class="model-background" style="z-index: 1050;" tabindex="-1"></div><div class="text-center" style="position: fixed; top: 35%; right: 0; left: 0; z-index: 1051;"><div class="modal-dialog"><div class="modal-content ui-draggable"><div class="modal-body"><h1 class="col-md-12" style="color:white;"><img src="' + WEB_ROOT + "/assets/w/app/images/" + options.icon + '"> ' + options.title + '</h1><div class="col-md-12 margin-top-20">MESSAGE</div><div class="col-md-12 margin-top-20 margin-bottom-20"><a href="javascript:;" close="#ModalView_1" class="btn btn-action confirm-btn ok-ModalView_1" style="min-width:120px;">' + options.button + "</a></div></div></div></div></div>";
