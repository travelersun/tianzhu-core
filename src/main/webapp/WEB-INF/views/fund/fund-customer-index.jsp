...
<body>
	<div class="row search-form-default">
		<div class="col-md-12">
			<form method="get" class="form-inline form-validation form-search form-search-init control-label-sm"
				data-grid-search="#grid-fund-customer-index">
	...
	<div class="row">
		<div class="col-md-12">
			<table id="grid-fund-customer-index"></table>
		</div>
	</div>
	
	<script type="text/javascript">
		$(function() {
		    $("#grid-fund-customer-index").data("gridOptions", {
		        url : WEB_ROOT + '/admin/fund/list',
		        colModel : [ {
		            label : '流水号',
		            name : 'id',
		            hidden : true                          
		        ...
		        editurl : WEB_ROOT + '/admin/fund/edit',
                editrulesurl : WEB_ROOT + '/admin/util/validate?clazz=${clazz}',
                fullediturl : WEB_ROOT + '/admin/fund/edit-tabs',
                delurl : WEB_ROOT + '/admin/fund/delete'
		    });
		});
    </script>
</body>
