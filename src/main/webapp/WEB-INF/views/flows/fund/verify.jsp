...
<li id="step3" class="status-curr"><span>账户信息</span></li>
<li id="step4" class="status-curr"><span>联系人信息</span></li>
</ul>
</div>
...
<form id="frm2" novalidate="novalidate" class="">
...
<div class="weui-cell__bd">
<input class="weui-input valid" id="CompanyName" name="CompanyName" type="text" value="" placeholder="请输入公司名称" aria-invalid="false">
</div>
<div class="weui-cell__ft">
<i class="weui-icon-warn"></i>
</div>
...
<div class="weui-cell__bd">
<input class="weui-input valid" id="CompanyAddress" name="CompanyAddress" type="text" value="" placeholder="请输入公司地址" aria-invalid="false">
</div>
<div class="weui-cell__ft">
<i class="weui-icon-warn"></i>
</div>
...
<div class="weui-cell__bd">
<input class="weui-input valid" id="CompanyPhoneNumber" name="CompanyPhoneNumber" type="text" value="" placeholder="请输入公司电话号码" aria-invalid="false">
</div>
<div class="weui-cell__ft">
<i class="weui-icon-warn"></i>
</div>
...
<div class="weui-cell__bd">
<input class="weui-input valid" data-val="true" data-val-number="字段 月收入(元) 必须是一个数字。" data-val-range="请输入 0~1.79769313486232E+308" data-val-range-max="1.79769313486232E+308" data-val-range-min="0" id="MonthlyIncome" name="MonthlyIncome" type="number" value="" placeholder="请输入月收入" aria-invalid="false" aria-describedby="MonthlyIncome-error">
</div>
<div class="weui-cell__ft">
<i class="weui-icon-warn"></i>
</div>
...
<form id="frm3" class="" novalidate="novalidate">
...
<img class="weui-uploader__file" src="http://sby.fanzhoutech.com/mobile/applyform?par=A2CEC5E84AE38512">
...
<form action="${flowExecutionUrl}" method="post" id="frmAddOrUpdate">
<input type="hidden" id="eventId" name="_eventId" />
<div class="weui-cells__title" id="fathersInfo">父亲信息</div>
<div class="weui-cells weui-cells_form" data-id="fathersInfo">
<div class="weui-cell">
<div class="weui-cell__hd">
...
<div class="weui-cells__title" id="mothersInfo">母亲信息</div>
<div class="weui-cells weui-cells_form" data-id="mothersInfo">
<div class="weui-cell">
<div class="weui-cell__hd">
...
<div class="weui-cells__title" id="colleagueInfo">同事信息</div>
<div class="weui-cells weui-cells_form" data-id="colleagueInfo">
<div class="weui-cell">
<div class="weui-cell__hd">
...
<div class="weui-cells__title" id="spousesInfo">配偶/情侣信息</div>
<div class="weui-cells weui-cells_form" data-id="spousesInfo">
<div class="weui-cell">
<div class="weui-cell__hd">
...
<script type="text/javascript" src="/assets/fund/index5.js"></script>
