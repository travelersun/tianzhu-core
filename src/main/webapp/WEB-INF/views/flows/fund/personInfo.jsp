...
<li id="step2" class=""><span>补充信息</span></li>
<li id="step3" class=""><span>账户信息</span></li>
<li id="step4" class=""><span>联系人信息</span></li>
</ul>
</div>
<form id="frm1" class="form-action" action="${flowExecutionUrl}" method="post" novalidate="novalidate">
<input type="hidden" id="eventId" name="_eventId" value="submit" />
<input data-val="true" data-val-number="字段 商户申请单Id 必须是一个数字。" data-val-required="请输入 商户申请单Id" id="MerchantApplyFormId" name="MerchantApplyFormId" type="hidden" value="1896">
...
<input class="weui-input" id="Name" name="name" type="text" value="${customer.name}" placeholder="请输入姓名" data-val="true" data-val-required="请输入姓名">
</div>
...
<div class="weui-cell__bd">
<input class="weui-input" data-val="true" data-val-identitycode="身份证号码 格式错误" id="IdentityCode" name="certid" type="text" value="${customer.certid}" placeholder="请输入身份证号码" data-val-required="请输入身份证号码">
</div>
<div class="weui-cell__ft">
<i class="weui-icon-warn"></i>
</div>
...
<form id="frm2" novalidate="novalidate">
...
<a class="weui-btn weui-btn_primary" href="javascript:document.getElementById('frm1').submit()" id="btnNext">下一步</a>
</div>
...
<script type="text/javascript" src="/assets/fund/index2.js"></script>
