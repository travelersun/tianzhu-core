...
import com.gdtopway.aud.service.RevisionEntityService;
import com.gdtopway.core.annotation.MenuData;
import com.gdtopway.core.annotation.MetaData;
import com.gdtopway.core.audit.envers.EntityRevision;
...
import com.gdtopway.core.exception.WebException;
import com.gdtopway.core.pagination.ExtPageRequest;
...
public class RevisionEntityController extends BaseController<ExtDefaultRevisionEntity, Long> {
    ...
    public Page<EntityRevision> revisionList(HttpServletRequest request) {
        ...
        for (EntityRevision entityRevision : entityRevisions) {
            ...
            revEntity.addExtraAttribute("entityId", id == null ? "" : id.toString());
        }
