package com.gdtopway.core.web.exception;
...
import com.gdtopway.core.exception.BaseRuntimeException;
import com.gdtopway.core.exception.DuplicateTokenException;
import com.gdtopway.core.exception.ValidationException;
...
public class AnnotationHandlerMethodExceptionResolver implements HandlerExceptionResolver, Ordered {
    ...
    private static final Logger logger = LoggerFactory.getLogger("com.gdtopway.errors");
