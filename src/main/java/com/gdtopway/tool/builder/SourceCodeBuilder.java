package com.gdtopway.tool.builder;
...
import com.gdtopway.core.web.json.DateJsonSerializer;
...
public class SourceCodeBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 设置FreeMarker的模版文件位置
        cfg.setClassForTemplateLoading(SourceCodeBuilder.class, "/com/gdtopway/tool//builder/freemarker");
