package com.tianzhu.tool.builder;
...
import com.tianzhu.core.web.json.DateJsonSerializer;
...
public class SourceCodeBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 设置FreeMarker的模版文件位置
        cfg.setClassForTemplateLoading(SourceCodeBuilder.class, "/com/tianzhu/tool//builder/freemarker");
        ...
        Set<BeanDefinition> beanDefinitions = scanner.findCandidateComponents("com.tianzhu.biz.fund.entity");
