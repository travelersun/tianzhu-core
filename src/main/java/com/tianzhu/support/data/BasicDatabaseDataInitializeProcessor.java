package com.tianzhu.support.data;
...
import com.tianzhu.core.data.DatabaseDataInitializeProcessor;
import com.tianzhu.core.security.AuthUserDetails;
import com.tianzhu.core.util.DateUtils;
import com.tianzhu.core.util.Exceptions;
import com.tianzhu.core.util.UidUtils;
...
import com.tianzhu.module.auth.service.DepartmentService;
...
import com.tianzhu.module.sys.service.ConfigPropertyService;
...
public class BasicDatabaseDataInitializeProcessor extends DatabaseDataInitializeProcessor {
    ...
    public void initializeInternal() {
        ...
        if ( null == userService.findByAuthUid("admin") && null == userService.findByAuthUid("mgmt")) {
