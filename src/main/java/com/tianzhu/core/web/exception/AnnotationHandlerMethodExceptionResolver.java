package com.tianzhu.core.web.exception;
...
import com.tianzhu.core.exception.BaseRuntimeException;
import com.tianzhu.core.exception.DuplicateTokenException;
import com.tianzhu.core.exception.ValidationException;
...
public class AnnotationHandlerMethodExceptionResolver implements HandlerExceptionResolver, Ordered {
    ...
    private static final Logger logger = LoggerFactory.getLogger("com.tianzhu.errors");
