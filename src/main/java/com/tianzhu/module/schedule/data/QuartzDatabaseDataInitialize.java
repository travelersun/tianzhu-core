package com.tianzhu.module.schedule.data;
        ...
        try {
            ...
            try {
                ...
                if (name.indexOf("mysql") > -1) {
                    sqlFile = "com/tianzhu/module/schedule/data/quartz/tables_mysql.sql";
                    ...
                    sqlFile = "com/tianzhu/module/schedule/data/quartz/tables_h2.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                } else if (name.indexOf("microsoft") > -1 || name.indexOf("sql server") > -1) {
                    //In your Quartz properties file, you'll need to set 
                    //org.quartz.jobStore.driverDelegateClass = org.quartz.impl.jdbcjobstore.MSSQLDelegate
                    sqlFile = "com/tianzhu/module/schedule/data/quartz/tables_sqlServer.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                    ...
                    sqlFile = "com/tianzhu/module/schedule/data/quartz/tables_oracle.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                }
